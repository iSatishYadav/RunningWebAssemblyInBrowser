...
* **[Optional]** Check _Progressive Web Application_. More on Progressive Web App in a later article.
    ...
    ![{43699453 F E18 4883 91 A6 E69481 D923 D5}](images/{43699453-FE18-4883-91A6-E69481D923D5}.png)
* Let's have a look at the Code generated by the template:

    ![{221578 E D A39 F 4 A B2 8076 B5 F D B A D05801}](images/{221578ED-A39F-4AB2-8076-B5FDBAD05801}.png)
...
* Run this shell application. A simple application with a Nav Bar saying Hello, world!
    ...
    ![{F E0 D2 E80 701 C 41 A4 B C E E 10 E09227 D F58}](images/{FE0D2E80-701C-41A4-BCEE-10E09227DF58}.png)

* If you've checked the _Progressive Web Application_ checkbox, you'll see the standard Install icon, click on it.

    ![{B E6 E0 F70 8 B8 A 4661 8 B3 E 22 E E5 A64 B1 C7}](images/{BE6E0F70-8B8A-4661-8B3E-22EE5A64B1C7}.png)
...
* Add a new Blazor `Component` named Hash which will calculate `SHA256` hash of a given input. 
    ...
    ![{1 E20 D D17 D1 C6 41 F E B1 D F E8 A81 E D29 B85}](images/{1E20DD17-D1C6-41FE-B1DF-E8A81ED29B85}.png)
...
* Run this application and enter a text in the input and press Submit!
    ...
    ![{E C D7614 E A A D7 4647 9206 F D18430367 D2}](images/{ECD7614E-AAD7-4647-9206-FD18430367D2}.png)
...
* Behind the scene, Blazor generates a `blazor.boot.json` to determin which `DLLs` need to downloaded and then stores them into browser's Cache. You can verify it by going to Dev Tools..
    ...
    ![{64 B55 A B6 B692 41 D0 99 F4 73 C5 B9 F50 B24}](images/{64B55AB6-B692-41D0-99F4-73C5B9F50B24}.png)
...
* These assemblies are stored as follows:
  ...
  ![{38 A D E A4 F A E C0 4926 9551 4 E1 C1449975 F}](images/{38ADEA4F-AEC0-4926-9551-4E1C1449975F}.png)
